...
#define STRING_CONFIG_H_AUTHOR "Keir Rice" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Salt"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "1d209cd4-e43c-4d76-a40b-38b73c948759"
...
#define MP_SCARA
  ...
  #define SCARA_LINKAGE_1 318       // (mm)
  #define SCARA_LINKAGE_2 318       // (mm)

  // SCARA tower offset (position of Tower relative to bed zero position)
  // This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
  #define SCARA_OFFSET_X  318       // (mm)
  #define SCARA_OFFSET_Y  318       // (mm)
...
#define X_BED_SIZE 636
#define Y_BED_SIZE 636
